...
fun EntityDamageByEntityEvent.damagerMeleeHitPlayerWithEnchant(
    enchant: Enchant,
    callback: EventCallback<PlayerMeleeHitPlayerContext>
) {
    val damaged = this.entity as? Player ?: return
...
fun EntityDamageByEntityEvent.damagerArrowHitPlayerWithEnchant(
    enchant: Enchant,
    callback: EventCallback<ArrowHitPlayerContext>
) {
    val damaged = this.entity as? Player ?: return
...
fun EntityDamageByEntityEvent.damagedReceivedAnyHitWithPantsEnchant(
    enchant: Enchant,
    callback: EventCallback<DamagedReceivedAnyHitWithPantsEnchantContext>
) {
    val damaged = this.entity as? Player ?: return
    val damager = this.damager
 ...
 * hitting an entity.
 */
fun EntityShootBowEvent.arrowShotWithEnchant(
    enchant: Enchant,
    getBowOnShoot: Boolean = false,
    callback: EventCallback<ArrowShotWithEnchantContext>
) {
...
fun PlayerDeathEvent.damagerMeleeKillPlayerWithEnchant(
    enchant: Enchant,
    callback: EventCallback<DamagerMeleePlayerKillWithEnchantContext>
) {
...
fun PlayerDeathEvent.damagerArrowKillPlayerWithEnchant(
    enchant: Enchant,
    callback: EventCallback<DamagerArrowPlayerKillWithEnchantContext>
) {
...
fun PlayerDeathEvent.damagerAnyKillPlayerWithPantsEnchant(
    enchant: Enchant,
    callback: EventCallback<DamagerAnyKillPlayerWithPantsEnchantContext>
) {
    val damaged = this.entity ?: return
    val damager = this.entity.killer ?: return
